...
type ProductionItem = { id: number; country: string; content_type: string; symbol: string; stock_name: string; target_date: string; assembled_date: string; title: string | null; status: string; uploaded_at: string | null; youtube_url: string | null };
