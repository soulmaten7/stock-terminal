      ...
      <div className="w-full max-w-sm rounded-xl border border-unjong-border bg-unjong-surface p-8 text-center">
        ...
        {phase === 'checking' ? (
          ...
          <button
            ...
            onClick={login}
            disabled={loading}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-md border border-unjong-border bg-white py-3 font-semibold text-[#1f1f1f] transition-colors hover:bg-gray-100 disabled:opacity-50"
          >
