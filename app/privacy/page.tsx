export const metadata = { title: "개인정보처리방침 | 운종" };
...
const SECTIONS: { h: string; body: string[] }[] = [
  ...
  },
  {
    h: "4. 개인정보의 제3자 제공",
    body: [
      "운종은 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다.",
  ...
  },
  {
    ...
    body: [
      "운종은 서비스 운영을 위해 회원 인증·데이터베이스 호스팅 업무를 Supabase, Inc.에 위탁합니다.",
  ...
  },
  {
    h: "7. 쿠키의 운영",
    body: [
      "운종은 로그인 세션 유지를 위해 필수 쿠키를 사용합니다.",
  ...
  },
  {
    h: "8. 개인정보의 안전성 확보 조치",
    body: [
      "운종은 접근권한 관리, 전송구간 암호화(HTTPS) 등 합리적인 보호조치를 취합니다.",
    ],
  },
  {
    h: "9. 개인정보 보호책임자",
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mb-8 text-sm leading-relaxed text-unjong-muted">
        운종(이하 &lsquo;서비스&rsquo;)은 이용자의 개인정보를 중요하게 생각하며,
        「개인정보 보호법」 등 관련 법령을 준수합니다. 본 방침은 운종이 어떤 개인정보를
