  ...
  return (
    <div className="min-h-[calc(100vh-7rem)] flex items-center justify-center">
      <div className="w-full max-w-md mx-auto p-8 bg-white rounded-2xl shadow-lg border border-border">
        ...
        <p className="text-text-secondary text-center text-sm mb-8">StockTerminal에 오신 것을 환영합니다</p>
        ...
        <p className="text-center text-text-secondary text-sm mt-6">
          계정이 없으신가요?{' '}
          <Link href="/auth/signup" className="text-accent hover:underline">회원가입</Link>
        </p>
      </div>
    </div>
  );
