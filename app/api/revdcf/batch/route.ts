...
export async function GET(req: Request) {
  ...
  // 🔴 899: components/RevDcfSection.tsx와 규칙을 공유(lib/revdcf/lossMaking.ts).
  ...
  for (const r of rows ?? []) verdicts[r.symbol.toUpperCase()] = { verdict: r.verdict, gapYears: r.gap_years, lossMaking: isLossMaking(r.operating_margin) };
