<!-- 2026-05-27 -->
# 운종(雲從) · UNJONG — 개발 명령서 (V3 명세, 보존 문서)

> **⚠️ 보존 알림** (2026-05-27 세션 #25): 이 문서는 V3 시절 작성된 개발 명세입니다.
> 운종(雲從) V4 비전·구조는 `docs/PRODUCT_SPEC_V4.md` 를 참조하세요.
> V3 시절 명세 (5섹션 대시보드 · 16개 위젯 · 풀스크린 페이지 등) 는 보존 차원에서 유지됩니다.
> Layer 0 (운종 V4) 완성 상태는 `docs/SESSION_KICKOFF.md` 에 정리되어 있습니다.
