            ...
            <div className="flex-1 overflow-y-auto overscroll-contain px-4 pb-4">
              ...
              <div className="mb-4 rounded-xl border border-unjong-border bg-unjong-background p-3">
                <div className="mb-2 flex items-baseline justify-between">
                  ...
                  <span className="text-base font-bold tabular-nums text-unjong-primary">{selectedStock.price ? formatPrice(selectedStock.price, curCode) : '—'}</span>
                </div>
