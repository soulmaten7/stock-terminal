...
> 🎨 **2026-07-17 (최신) · 베타 UX·가독성 폴리시 + 지수 티커 이중방어 + 광고문의 언어권 차등 (HEAD `8c7c7a8`).**
...
> - **▶ 다음(선택) = `/en` 전역 푸터 advisory(KR 전용) 문구 정리(별개 관찰) · 클로즈드 베타 초대(BETA_INVITE.md 준비됨) · (선택) 모바일 폰트 크기 미세조정.**
>
