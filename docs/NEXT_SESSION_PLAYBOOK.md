...
>
> **시점 스냅샷**: 2026-06-04 STEP 153 종료 (V7 — 마켓 국내+미국 랭킹) + 마이그레이션 020·021·022 적용 완료
> **HEAD 커밋**: `33e72f7` (STEP 153 코드) — 본 문서 커밋이 그 위 docs 커밋 (다음 세션 `git log` 로 최신 확인)
> **마지막 코드 변경**: `33e72f7` (STEP 153 · 마켓 미국 랭킹 — us-movers 확장 + 국가 분기)
