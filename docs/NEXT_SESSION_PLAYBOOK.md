...
>
> **시점 스냅샷**: 2026-06-22 STEP 345 종료 — **게이트웨이 카테고리 탭에 우측 실시간 피드 8종 완성**(뉴스·공시DART·거시ECOS+FRED·기업재무/리포트/ETF·배당·공모주) + 종목·상품 탭(멀티컬럼 수익률표+증권사 순위) + 🔴로그인 데드락 해소 + 법정 페이지.
> **HEAD 커밋**: `c0b3035` (STEP 345 · 공모주 피드 파싱 수정). 빌드 ✓.
