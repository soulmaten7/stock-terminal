...
>
> **시점 스냅샷**: 2026-06-07 STEP 206 종료 (V7 — 리딩방·채널 랭킹 + 좋아요/싫어요 DB + 투자상품 미리보기)
> **HEAD 커밋**: `2bf1bc7` (STEP 206 코드) — 본 문서 커밋이 그 위 docs 커밋 (다음 세션 `git log` 로 최신 확인)
> **마지막 코드 변경**: `2bf1bc7` (STEP 206 · 리딩방/채널 좋아요·싫어요·조회 정렬). DB 023(`leading_room_votes`) 운종 DB 적용 완료
