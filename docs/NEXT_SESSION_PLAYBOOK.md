...
>
> **시점 스냅샷**: 2026-06-15 STEP 241 종료 (홈 = 상품 성적표 재편 + 헤더 정리 — 전략 대화로 정체성 재확정 후 UI 전면 재설계)
> **HEAD 커밋**: `bbf4e88` (STEP 241 코드) — 본 문서 커밋이 그 위 docs 커밋 (다음 세션 `git log` 로 최신 확인)
> ⚠️ STEP 240(ETF 미리보기 폭) 미적용 — `docs/STEP_240_COMMAND.md`만 있고 239→241 건너뜀. 다음 세션 적용 대기.
