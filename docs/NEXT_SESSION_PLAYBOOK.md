...
>
> **시점 스냅샷**: 2026-06-06 STEP 168 종료 (V7 토스증권 오마주 — 홈 지수·티커·수급·풀폭)
> **HEAD 커밋**: `959d8fa` (STEP 168 코드) — 본 문서 커밋이 그 위 docs 커밋 (다음 세션 `git log` 로 최신 확인)
> **마지막 코드 변경**: `959d8fa` (STEP 168 · 하단 티커 금액+이동+투자유의사항 라벨)
