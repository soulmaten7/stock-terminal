<!-- 2026-04-08 (V3) -->
# 운종(雲從) · UNJONG — 시스템 설계서 (V3 명세, 보존 문서)

> **⚠️ 보존 알림** (2026-05-27 세션 #25): 이 문서는 V3 시절 작성된 시스템 아키텍처 (StockTerminal 명) 입니다.
> 운종(雲從) V4 의 3컬럼 구조·21개 카드·디테일 페이지 아키텍처는 `docs/_archive/PRODUCT_SPEC_V4.md` 와 `docs/_archive/SESSION_KICKOFF.md` 섹션 3·7 참조.
> Next.js 16 · Tailwind v4 · Supabase · Zustand · TradingView 기술 스택은 V4 에서도 유지됩니다.

<!-- 이 문서는 V3 시절 5섹션 대시보드 16개 위젯 + 풀스크린 페이지 명세입니다 -->
<!-- 운종 V4 작업 시에는 docs/_archive/PRODUCT_SPEC_V4.md 우선 참조 -->
