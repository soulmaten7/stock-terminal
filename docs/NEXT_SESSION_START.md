...
>
> **현재 상태**: ~142 + 홈 데이터 섹션 복구(143) 완료. 빌드 ✓ (HEAD `fbb25d7` — STEP 143). 홈 = `components/home-v6/HomeClientV6` 포털형. 브리핑(야후 라이브러리)·거래량랭킹(실값)·업종테마(market=KR/US) 복구 + 랭킹 레터아바타. 종목 탭 5종: 차트·시세/토론/뉴스/공시/인사이트.
