...
> 🆕 **2026-07-06 (최신) — STEP 600~611 (HEAD `b2079b7`): 'AI 렌즈' 브랜딩·발견성 + KR AI 확장(R2·R3) + JP R3 뉴스.**
...
> - **국가별 AI: US R1·R2·R3 / KR R1·R2·R3 / JP R3(공시=EDINET 대기·무료 키) / CN 미착수.** ▶ **다음 = CN R3 / JP EDINET / SEO — 국가 확장은 사용자 승인 후.**
>
