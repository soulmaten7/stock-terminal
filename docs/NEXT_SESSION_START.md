...
> **Last updated**: 2026-06-04 (STEP 147 — 종목 메타 보강: 외국인 소진율·상장주식수)
> ⭐ **더 디테일한 마스터 인수인계**: `docs/NEXT_SESSION_PLAYBOOK.md`. **마스터 비전**: `docs/PRODUCT_SPEC_V6.md` (정체성 축 = "안 속는 곳").
>
> **현재 상태**: STEP 147 까지 완료. 빌드 ✓ (HEAD `99864a3` — STEP 147 코드). 홈 = `components/home-v6/HomeClientV6` 포털형(지수바 스파크라인 + 브리핑 "—" 안정화). 종목 페이지 좌측에 외국인 소진율·상장주식수 메타 추가. 종목 탭 5종: 차트·시세/토론/뉴스/공시/인사이트.
...
## 0. 진행 상태 한눈 (2026-06-04 기준 · HEAD `99864a3` STEP 147)
