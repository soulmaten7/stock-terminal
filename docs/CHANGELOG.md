...
- **before 실측**: 코스닥 가격괴리≥20% **130/433(29.9%)**·이름 오염 174 / 코스피 5/505·5. → after 재측정(§측정문서).
- **라이브**(kr-lens-scores 재실행): 코스닥 ≥20% 130→?·이름 오염 174→0·KR 컷 전/후·N 전/후. US·다른 렌즈 문구 불변. tsc 0·vitest 135·build ✓. 교훈 = `LENS_DEV_PLAYBOOK` #66.
