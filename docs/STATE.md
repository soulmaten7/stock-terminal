...
| **④** | **섹터 내 컷 계산** — p30/p70. 🔴 **표본 확보 섹터만**(하위 6개 26~48종목) | 🔵 **다음 — 미착수.** 942 최종 실측이 직접 입력: 섹터별 종목 수(`docs/probe_942_final_resolve.json` `sectorCounts`, 하위 6개 Utilities43~Materials61 — 940 기준 40~50에서 전부 상승). **🔴 착수 전 §7 ⓕ(섹터 어휘 충돌)·ⓖ(모집단 1,021 vs 604) 판정 필요**(아래) |
