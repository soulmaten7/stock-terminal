...
## HEAD / 배포
- HEAD = **이 커밋(STEP 931 `4b95bf0`)** · 부모(STEP 930 `a10fbfa`) · **push 완료 — origin/main + revdcf-preview 반영(rebase 불필요).** STEP 931 = 930 CHANGELOG 소급 기록((75)번) + 931 자신 기록((76)번) + 플레이북 2건 — `docs/STATE.md` 본문은 이 HEAD 줄 외 무변경.
