...
68. 🔴 **신규 등재(999) — 업종베타가 Damodaran 단일 소스, 대체재 없음.** 998의 92개 소스 전수조사에서도 무료 대체 업종베타 소스를 찾지 못했다(슬롯#16·#20, "후보 1개뿐인 슬롯"). Damodaran이 연1회(1월) 갱신을 멈추거나 접근이 막히면 역DCF WACC 전체가 계산 불가능해진다 — 단일장애점(SPOF). 미해결·미판정(대응 방안 없음, 이번엔 조사만).
