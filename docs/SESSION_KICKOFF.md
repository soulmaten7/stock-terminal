...
> **Last refreshed**: 2026-06-26 (STEP 405~412 — US 종목 탭 신설·KR 구조 통일·종목표 UI 리파인·US 기간 백그라운드 미리계산·언어 선택기 + KR 링크허브 71 큐레이션 + Trillion AI 분석 로드맵)
> **실행 환경**: Mac 로컬 `~/stock-terminal` 에서 직접 실행 (배포 ✓ — onetrillion.app 라이브)
> **현재 커밋**: `9984804` (STEP 405~412 + 문서) — 배포 ✓ onetrillion.app
