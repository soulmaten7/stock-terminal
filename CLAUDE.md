...
## 프로젝트 개요
**운종(雲從) · UNJONG** — **한국 금융 동선의 출발점** · 정보 + 대화 + 허브 + 신뢰 4박자 플랫폼.
브랜드명: 운종 (UNJONG, 한자 雲從 코드 표기 X — 영문+한글만).
**V5 정체성 (2026-06-01 합의)**: 네이버 페이 증권 레이아웃 + 토스 증권 카드 디자인 + Trustpilot 평가 모델 = 운종 고유.
...
**최신 비전 (2026-06-03 확정)**: `docs/NEXT_SESSION_START.md`
