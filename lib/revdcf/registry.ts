...
export const INPUTS: RegistryEntry[] = [
  ...
  },
  {
    ...
    klass: "A",
    divergence:
      "✅(배선) 852 이중 산정 유지: level·marginal 둘 다 계속 저장(재현·재검토용). ✅ 원전대조판정 확정(880·2026-08-03 장은태) — **marginal을 주 판정으로 채택, level은 주 판정에서 내림.** 🔑 정본: `docs/LENS_COMPLETION_STANDARD.md` 진행표 4행 — 근거·대가·재검토조건.",
    open: "🅿️ 재검토 조건: 정본 = `docs/LENS_COMPLETION_STANDARD.md` 진행표 4행 각주(§10 #54). 크론 다음 정규 실행부터 marginal 반영(880은 수동 실행 안 함).",
  },
  {
    ...
    klass: "A",
    divergence:
      "✅(배선) 847 T4 판독+실측: 원전은 무이자유동부채만 차감(`Tutorial 4` B23 명시된 설계). ✅ 원전대조판정(875·2026-08-03 장은태 승인): 현행(수준형) 유지. 🔑 정본: `docs/LENS_COMPLETION_STANDARD.md` 진행표 3행 — 근거·대가·불리한사실·재검토조건(§10 #46).",
  },
  {
    id: "taxRate",
    ko: "세율",
