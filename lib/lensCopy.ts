  ...
  ko: {
    momentum: {
      ...
      scope: {
        ...
        failure: "12~18개월 뒤엔 오히려 뒤집히는 경향(부분 반전)이 있고, 급락 뒤 급반등장에선 크게 무너지는 '모멘텀 크래시'가 알려져 있어요. 또 우리 순위는 '오늘 기준 상위 1,000종목'(KR=거래대금·US=시총 상위)끼리라 상장폐지·쪼그라든 종목이 빠진 생존자들 사이의 순위예요(논문은 상장폐지분까지 포함). '이 종목이 오른다'는 뜻이 아니에요.",
  ...
  en: {
    momentum: {
      ...
      scope: {
        ...
        failure: "It tends to partly reverse 12-18 months later, and it can break down badly in sharp rebounds after a crash (a 'momentum crash'). Also, our ranking is among today's top 1,000 names (KR = by trading value, US = by market cap), so delisted or shrunken stocks are missing — a rank among survivors (the papers include delisted returns). It does not mean this stock will rise.",
