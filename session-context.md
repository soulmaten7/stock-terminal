<!-- 2026-07-02 -->
<!-- Last GC: 2026-07-02 (신뢰도 업그레이드 사이클 종료 STEP 525~537·HEAD 5bdf56f. 5렌즈 t·알파 재검: 모멘텀=검증유의·저변동=위험대비·밸류=표본약함·F=수익신호아님·기술=참고용. 대기: #18 5개지역 매매처 / #30 [앱]외부링크 / #47 유료AI보기=보류. 다음=KR/글로벌 렌즈확장 or 새기법 or 생존편향없는데이터 승격) -->
