<!-- 2026-07-04 -->
<!-- Last GC: 2026-07-04 (STEP 539~568·HEAD ebbf3d8. 렌즈 7기법=모멘텀·저변동·퀄리티(검증)/밸류·자산성장(표본약함)/F-Score(건전성)/기술(참고). 주주환원·발생액=탈락·마법공식=보류·강력후보 소진. 3중 교차검증(559~561): 모멘텀·퀄리티 시기무관 단단·나머지 정직 재확인(등급 불변). 카드=패밀리룩(접힘 기법메뉴/펼침 판정+3구간 스펙트럼+"이 기법 방향" outlook)·근거수치 병기·중립·모바일. 청사진 4층=원자→방향→조합전략→TRAI. 원칙: 채용=효용(독립성)/등급=유의성·렌즈=사실/앞은 TRAI(의견). 대기: #18 5개지역 매매처 / #30 [앱]외부링크 / #47 유료TRAI=보류. 다음=세부 문구·전종목 미리계산(스크리닝)·검증된 조합전략. 새 기법 추가는 일단락) -->
